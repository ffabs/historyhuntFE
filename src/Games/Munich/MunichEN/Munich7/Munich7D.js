    ...
    return ( 
      <div>
        ...
        <div className="clue-background">
          ...
          <div>
              <img src={munich_clue7help} className="solution-image" alt="st. Michael" />
          </div>
          <div className="clue-background-divs">
            <div className="clue-background-div">Even William's own child and successor studied here and was very religious and William himself was buried in this church.</div>
            {/* <div><img src={munichflag} className="memorial-image" alt="munich-flag" /></div> */}
            <div className="clue-background-div">William did not build only Churches though...</div>
          </div>
        </div>
