      ...
      return ( 
        <div>
          ...
          <div className="clue-background">
            <div className="clue-background-title">Chapel opening times:</div>
            <div className="clue-background-div">Apr-Oct: 9am-6pm</div>
            <div className="clue-background-div">Nov-Mar: 10am-4.30pm</div>
