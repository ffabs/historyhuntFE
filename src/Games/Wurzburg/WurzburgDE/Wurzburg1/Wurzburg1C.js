            ...
            return ( 
                <div>
                    ...
                    <div className="clue-background">       
                        ...
                        <div className="clue-background-div">Ich habe keine Angst vor dem Tod. Normalerweise halte ich ein Messer, aber es fehlt derzeit in meiner Statue. Ich erinnere mich als...</div>
                        <div>
                            <input
                                type="text" 
                                name="thirdInput"
