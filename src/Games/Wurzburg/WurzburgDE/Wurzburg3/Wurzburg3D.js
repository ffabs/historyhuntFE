...
if (consent === "true") {
    ...
    ReactGA.pageview('/DE/wurzburg3D');
}
...
class Wurzburg3D extends Component {
    ...
    render() {
        if(this.state.answers === "right"){
            return (
                <Redirect to="/DE/wuerzburg/citycouncil/sundial/clueAnswer" />
            ) 
        } else {
            return ( 
                <div>
                    ...
                    <div className="clue-background">
                        <div className="clue-background-div">Wann wurde der Baum neu gestrichen?</div>
                    </div>
                        <div className="wurzburg3Dform"> 
                            <div className="number-form">
                                <select onChange={this.updateSeason} className={this.state.seasonCSS}>
                                    <option value="middle"> Um die Mitte </option>
                                    <option value="beginning"> Zu Beginn </option>
                                    <option value="end"> Ende </option>
                                </select>
                            </div>
                            <div className="closerTop center">
                                <div className="clue-background-div">des</div>
                            </div>
                            <div className="number-form">
                                <button 
                            ...
                            <div className="center">
                                <div className="clue-background-div">Jahrhunderts</div>
                            </div>
                        </div>
                    <div className="buttons-section">
                        ...
                        <Link to="/DE/wuerzburg/citycouncil/help">
