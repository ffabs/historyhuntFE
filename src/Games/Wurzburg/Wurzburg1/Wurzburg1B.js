  ...
  return ( 
    <div>
      ...
      <div className="clue-background">
        ...
        <div className="clue-background-div">The three saints are are still commemorated on this very bridge today, each with a statue among the 12 present here.</div>
      </div>
